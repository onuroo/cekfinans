			...
			<View style={styles.content}>
				<ScrollView contentContainerStyle={{paddingBottom: 40,}}>
					...
					<View style={[styles.row, {flexDirection: 'row', alignItems: 'center', alignContent: 'center'}]}>
						<Text color={color.secondary} h6 style={{padding: 10, marginBottom: 0, justifyContent: 'center'}}>+90</Text>
					...
					<View style={styles.row}>
						<Button variant={'primary'} color={color.white} title={'Gönder'} onPress={() => console.log('press')}/>
					</View>
				</ScrollView>
